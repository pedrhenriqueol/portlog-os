...
import { Layers, Plus, Search, Wrench, Clock, ShieldCheck, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="py-2 px-4 bg-port-accent hover:bg-port-accentHover text-white font-medium rounded-xl transition-all shadow-md flex items-center gap-2 text-xs">
          ...
          >
            <div>
              ...
              <div className="mt-4 space-y-2 pt-3 border-t border-port-border/40 text-xs text-gray-400">
                ...
                <div className="flex items-center justify-between">
                  <span className="flex items-center gap-1.5 text-gray-400">
                    <Clock className="w-3.5 h-3.5 text-port-amber" />
                    Horímetro Acumulado:
                  </span>
            ...
            <div className="mt-5 pt-3 border-t border-port-border/40 flex items-center justify-between text-xs text-gray-500">
              ...
              <button className="text-port-accent hover:underline text-[11px] font-medium">
                Ver Histórico ➔
              </button>
            </div>
          </div>
